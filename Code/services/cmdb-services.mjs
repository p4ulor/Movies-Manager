...
export async function deleteGroup(groupID, token){
    try {
        const userID = (await getUserByToken(token).id).id
...
export async function removeMovieFromGroup(groupID, movieID, token){
    try {
        //const userID = (await getUserIDByToken(token)).id
...
async function getUserByToken(token){
    return  await dataMem.tryFindUserBy_(null, token, null, )
